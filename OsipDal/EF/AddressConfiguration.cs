...
namespace OsipDal.EF
{
    ...
    public class AddressConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Address>
    {
        ...
        public AddressConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasRequired(a => a.Country).WithMany(b => b.Addresses).HasForeignKey(c => c.CountryId); // FK_Address_Country
            HasRequired(a => a.County).WithMany(b => b.Addresses).HasForeignKey(c => c.CountyId); // FK_Address_County
            HasRequired(a => a.Town).WithMany(b => b.Addresses).HasForeignKey(c => c.CityId); // FK_Address_City
