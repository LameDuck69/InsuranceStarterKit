...
namespace OsipDal.EF
{
    ...
    public class PersonPasswordConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<PersonPassword>
    {
        ...
        public PersonPasswordConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasRequired(a => a.Password).WithMany(b => b.PersonPasswords).HasForeignKey(c => c.PasswordId); // FK_PersonPassword_Password
            HasRequired(a => a.Person).WithMany(b => b.PersonPasswords).HasForeignKey(c => c.PersonId); // FK_PersonPassword_Person
        }
    }
