...
namespace OsipDal.EF
{
    ...
    public class QuestionConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Question>
    {
        ...
        public QuestionConfiguration(string schema)
        {
            ...
            Property(x => x.QuestionText).HasColumnName("QuestionText").IsRequired().IsUnicode(false).HasColumnType("varchar");
            ...
            Property(x => x.QuestionHint).HasColumnName("QuestionHint").IsOptional().IsUnicode(false).HasColumnType("varchar");
            Property(x => x.GuiId).HasColumnName("GuiID").IsOptional().HasColumnType("int");

            // Foreign keys
            HasRequired(a => a.QuestionType).WithMany(b => b.Questions).HasForeignKey(c => c.QuestionTypeId); // FK_Question_QuestionType
        }
    }
